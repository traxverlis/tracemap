...
def upgrade() -> None:
    ...
    op.create_index('ix_accounts_identity_platform', 'accounts', ['identity_id', 'platform'], unique=False)
    ...
    op.create_table('completeness_targets',
    sa.Column('identity_id', sa.String(length=36), nullable=False),
    ...
    op.create_index('ix_identifiers_identity_type', 'identifiers', ['identity_id', 'type'], unique=False)
    op.create_index('ix_identifiers_normalized', 'identifiers', ['type', 'normalized_value'], unique=False)
    ...
    op.create_index('ix_relationships_source', 'relationships', ['source_entity_type', 'source_entity_id'], unique=False)
    op.create_index('ix_relationships_target', 'relationships', ['target_entity_type', 'target_entity_id'], unique=False)
    ...
    op.create_index('ix_findings_identity_category', 'findings', ['identity_id', 'category'], unique=False)
